...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white shadow-sm border-b border-gray-200 h-16 ml-64">
      <div className="flex items-center justify-between px-6 h-full">
        ...
        <div className="flex items-center space-x-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={logout}
            className="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 rounded-lg transition-colors"
          >
            Logout
          </motion.button>
        </div>
